 ...
 * analysis, pre-evaluation, grading-write, ops, and management tools).
 * Idempotent per call — registration rejects duplicate names, so calling it
 * more than once with the same set throws.
 */
